...
export const Auth = () => {
  ...
  const onSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userId) {
        await supabase.from("user_profiles").upsert({ id: userId, email }).throwOnError();
      }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="backdrop-blur-sm bg-slate-800/80 border border-slate-700/50 shadow-2xl">
          <CardHeader className="space-y-3 pb-6">
            <div className="flex items-center justify-center gap-3 mb-2">
              ...
              <CardTitle className="text-3xl font-bold text-cyan-400">Gold Crafts Manager</CardTitle>
            </div>
            <p className="text-center text-slate-300 text-sm">Account Management</p>
        ...
        <Card className="backdrop-blur-sm bg-slate-800/80 border border-slate-700/50 shadow-2xl">
          <CardHeader className="space-y-3 pb-6">
            <CardTitle className="text-3xl font-bold text-cyan-400">Get in Touch</CardTitle>
            <p className="text-white/70 text-sm">Fill out the form below and our team will contact you to help set up your business account.</p>
          </CardHeader>
